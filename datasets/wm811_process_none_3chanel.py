...
class WM811kProcessor(object):
    ...
    @staticmethod
    def save_image(arr: np.ndarray, filepath: str = 'image.png', vmin: int = 0, vmax: int = 2, to_rgb: bool = True):
    ...
    def write_unlabeled_images(self,
                               root: str = './data/wm811k/unlabeled/wm811k/',
    ...
    def write_labeled_images(self,
                             root: str = './data/wm811k/labeled/wm811k/',
                             train_size: float = 0.8,
                             valid_size: float = 0.1,
